...
public partial class VEagregarCliente : ContentPage
{
    ...
    public VEagregarCliente(int idUsuario, int idTipoUsuario)
    {
        ...
        TituloLabel.Text = "Informaci�n General";
    ...
    public VEagregarCliente(Cliente clienteSelect, int idUsuario, int idTipoUsuario)
    {
        ...
        // Aplicar la l�gica de visibilidad seg�n el tipo de documento seleccionado
    ...
    {
        // El picker tiene "DNI" en posici�n 0 y "RUC" en posici�n 1
    ...
    private async void OnGuardarClienteClicked(object sender, EventArgs e)
    {
        ...
        if (tipoDocumento == "RUC")
        {
            ...
            {
                await DisplayAlert("Error", "Verifique su n�mero de RUC. Debe tener 11 d�gitos.", "OK");
                return;
            }
        }
        else if (tipoDocumento == "DNI")
        {
            ...
            {
                await DisplayAlert("Error", "Verifique su n�mero de DNI. Debe tener 8 d�gitos.", "OK");
                return;
            }

            // Validar si el campo de apellidos est� vac�o
            ...
            // Validar que ambos apellidos est�n presentes

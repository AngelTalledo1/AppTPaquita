...
@dso_cache = dso_local local_unnamed_addr global [562 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
		i64 13172661, ; hash 0xc8ffb5, from name: libaot-AppTransporte.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 3063463790, ; hash 0xb698bf6e, from name: aot-AppTransporte.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AppTransporte.dll.so
		ptr null; void* handle (0x0)
	}, ; 410
	...
	%struct.DSOCacheEntry {
		i64 3680883563, ; hash 0xdb65d36b, from name: libaot-AppTransporte
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AppTransporte.dll.so
		ptr null; void* handle (0x0)
	}, ; 484
	...
	%struct.DSOCacheEntry {
		i64 3775322286, ; hash 0xe106d8ae, from name: aot-AppTransporte
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AppTransporte.dll.so
		ptr null; void* handle (0x0)
	}, ; 492
	...
	%struct.DSOCacheEntry {
		i64 3823053215, ; hash 0xe3df299f, from name: AppTransporte
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AppTransporte.dll.so
		ptr null; void* handle (0x0)
	}, ; 501
	...
	%struct.DSOCacheEntry {
		i64 4107517163, ; hash 0xf4d3bceb, from name: AppTransporte.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-AppTransporte.dll.so
		ptr null; void* handle (0x0)
	}, ; 536
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [123 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
